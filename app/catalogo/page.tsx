...
<div>
<h1 className="text-display-lg md:text-display-xl font-display-lg md:font-display-xl text-on-surface mb-2">GHOST_PUFFER v1</h1>
...
<button className="w-full bg-primary-container text-on-primary rounded-full py-4 px-8 text-body-lg font-body-lg font-semibold flex items-center justify-center gap-3 lolo-glow overflow-hidden relative group">
